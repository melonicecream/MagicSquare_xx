...
- 진짜 문제 (한 문장): [Report/MomTest-Report.md §4 참고 또는 인터뷰에서 확정한 한 문장]
...
> ⚠️ `[...]` 칸에 **질문 문장**이 아니라 **인터뷰 답변·인용**을 넣을 것. 비어 있으면 `Report/MomTest-Report.md`를 근거로 채움.
...
Report 폴더에 기록해줘
```
→ `Report/SESSION3-Workbook.md`

```
prompt 폴더에 프롬프트를 저장해줘
```
→ `prompt/session-3-workbook.md` (본 파일)

---

## Mom Test 결과 예시 (MagicSquare_xx)

`Report/MomTest-Report.md` 기준 — 프롬프트 `[...]`에 그대로 넣을 수 있음:
...
| 경로 | 설명 |
|------|------|
| [`Report/SESSION3-Workbook.md`](../Report/SESSION3-Workbook.md) | 세션 3 워크북 산출물 |
| [`Report/MomTest-Report.md`](../Report/MomTest-Report.md) | STEP 1 Mom Test |
| [`prompt/mom-test-interview.md`](./mom-test-interview.md) | 인터뷰 시작 |
| [`prompt/mom-test-interview-end.md`](./mom-test-interview-end.md) | 인터뷰 종료·추출 |
