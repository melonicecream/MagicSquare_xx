...
상세 10문항(✅/❌ + 고친 버전): [`MomTest-Interview-Questions.md`](./MomTest-Interview-Questions.md)

---

## 후속 작업

1. 인터뷰 종료 → [`mom-test-interview-end.md`](./mom-test-interview-end.md)
2. 보고서 저장 → `Report/MomTest-Report.md`
3. 세션 3 → [`session-3-workbook.md`](./session-3-workbook.md)

---

## 관련 파일

- [`Report/MomTest-Report.md`](../Report/MomTest-Report.md) — 인터뷰 결과 보고서
- [`prompt/MomTest-Interview-Questions.md`](./MomTest-Interview-Questions.md) — 질문 10개
